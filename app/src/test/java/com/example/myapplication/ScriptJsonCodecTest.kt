...
class ScriptJsonCodecTest {
    @Test fun roundTripPreservesFullActionTreeAndConditions() {
        ...
        val action = ScriptAction(
            ...
            afterActions = listOf(nested.copy(id = "after", executionOptions = ActionExecutionOptions(ActionCondition.Judgement(JudgementCondition.RegionColor("#ffffff", Rect(1, 2, 3, 4), tolerance = 8)))) )
        )
